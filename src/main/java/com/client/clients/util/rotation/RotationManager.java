package com.client.clients.util.rotation;
...
import com.client.clients.utils.events.impl.EventUseItemRayTrace;
...
import com.client.clients.util.client.ingame.entity.player.MoveUtils;
import com.client.clients.util.vectors.Vector2f;
...
public class RotationManager {
   ...
   public void updateGlobalYaw(EventRunTicks e) {
      if (e.getType() == EventType.PRE && mc.player != null) {
         Aura aura = (Aura) Client.getInstance().getModuleManager().getModule(Aura.class);
         Scaffold scaffold = (Scaffold) Client.getInstance().getModuleManager().getModule(Scaffold.class);
         AttackCrystal attackCrystal = (AttackCrystal) Client.getInstance().getModuleManager().getModule(AttackCrystal.class);
         AutoMLG autoMLG = (AutoMLG) Client.getInstance().getModuleManager().getModule(AutoMLG.class);
         AimAssist aimAssist = (AimAssist) Client.getInstance().getModuleManager().getModule(AimAssist.class);
         LongJump longJump = (LongJump) Client.getInstance().getModuleManager().getModule(LongJump.class);
         active = true;
