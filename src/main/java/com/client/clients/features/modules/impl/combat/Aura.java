...
import com.client.clients.utils.events.impl.EventShader;
...
import com.client.clients.util.client.ingame.entity.player.InventoryUtils;
import com.client.clients.util.client.NetworkUtils;
import com.client.clients.util.renderer.RenderUtils;
import com.client.clients.util.renderer.StencilUtils;
...
import com.client.clients.util.rotation.RotationUtils;
...
public class Aura extends Module {
   ...
   public void onMotion(EventRunTicks event) {
      if (event.getType() == EventType.PRE && mc.player != null) {
         if (mc.screen instanceof AbstractContainerScreen
            || Client.getInstance().getModuleManager().getModule(Stuck.class).isEnabled()
   ...
   public void onClick(EventClick e) {
      if (mc.player.getUseItem().isEmpty()
         && mc.screen == null
         && Client.skipTasks.isEmpty()
         && !NetworkUtils.isServerLag()
         && !Client.getInstance().getModuleManager().getModule(Blink.class).isEnabled()) {
